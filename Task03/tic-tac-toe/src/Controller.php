...
namespace kiryuhinal\tic_tac_toe\Controller;
    ...
    use kiryuhinal\tic_tac_toe\Model\Board as Board;
    use Exception as Exception;
    use LogicException as LogicException;

    use function kiryuhinal\tic_tac_toe\View\showGameBoard;
    use function kiryuhinal\tic_tac_toe\View\showMessage;
    use function kiryuhinal\tic_tac_toe\View\getValue;

    use const kiryuhinal\tic_tac_toe\Model\PLAYER_X_MARKUP;
    use const kiryuhinal\tic_tac_toe\Model\PLAYER_O_MARKUP;
